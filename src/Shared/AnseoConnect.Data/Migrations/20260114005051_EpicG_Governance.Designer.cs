...
namespace AnseoConnect.Data.Migrations
{
    ...
    [Migration("20260114005051_EpicG_Governance")]
    partial class EpicG_Governance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.AutomationMetrics", b =>
                {
                    ...
                    b.Property<decimal>("AttendanceImprovementDelta")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("PlaybooksStarted")
                        .HasColumnType("int");

                    b.Property<int>("PlaybooksStoppedByImprovement")
                        .HasColumnType("int");

                    b.Property<int>("PlaybooksStoppedByReply")
                        .HasColumnType("int");

                    b.Property<Guid>("SchoolId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("StepsScheduled")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.CaseIntervention", b =>
                {
                    b.Property<Guid>("CaseInterventionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("TierWhenApplied")
                        .HasColumnType("int");

                    b.HasKey("CaseInterventionId");
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.ClassGroup", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SchoolId", "ExternalClassId")
                        .IsUnique()
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.EvidencePack", b =>
                {
                    ...
                    b.Property<string>("GenerationPurpose")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.IngestionSyncLog", b =>
                {
                    ...
                    b.Property<decimal?>("ErrorRateThreshold")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int?>("MismatchThreshold")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.JobLock", b =>
                {
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.MtssIntervention", b =>
                {
                    b.Property<Guid>("InterventionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ApplicableTiersJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("EvidenceRequirementsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("RequiresParentConsent")
                        .HasColumnType("bit");

                    b.Property<Guid>("TenantId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int?>("TypicalDurationDays")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MtssInterventions");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.MtssTierDefinition", b =>
                {
                    b.Property<Guid>("TierDefinitionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("EscalationCriteriaJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ExitCriteriaJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("RecommendedInterventionsJson")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.PlaybookDefinition", b =>
                {
                    ...
                    b.Property<string>("TriggerStageType")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
                    ...
                    b.HasIndex("TenantId", "TriggerStageType", "IsActive")
                        .HasDatabaseName("IX_PlaybookDefinitions_TriggerStage");

                    b.ToTable("PlaybookDefinitions");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.PlaybookExecutionLog", b =>
                {
                    ...
                    b.HasIndex("RunId", "ScheduledForUtc")
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.PlaybookRun", b =>
                {
                    b.Property<Guid>("RunId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("NextStepScheduledAtUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasIndex("TenantId", "SchoolId", "Status", "NextStepScheduledAtUtc")
                        .HasDatabaseName("IX_PlaybookRuns_Status_NextStep");

                    b.ToTable("PlaybookRuns");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.PlaybookStep", b =>
                {
                    b.Property<Guid>("StepId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("SkipIfPreviousReplied")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.ReasonCodeMapping", b =>
                {
                    b.Property<Guid>("ReasonCodeMappingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("ReasonCodeMappingId");

                    b.HasIndex("TenantId", "SchoolId", "ProviderId", "ProviderCode")
                        .IsUnique()
                        .HasDatabaseName("IX_ReasonCodeMappings_Provider_Code");

                    b.ToTable("ReasonCodeMappings");
                });
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.SchoolSyncState", b =>
                {
                    b.Property<Guid>("SchoolSyncStateId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("LastSyncWatermarkUtc")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.HasKey("SchoolSyncStateId");

                    b.HasIndex("TenantId", "SchoolId", "ProviderId", "EntityType")
                        .IsUnique()
                        .HasDatabaseName("IX_SchoolSyncStates_Provider_Entity");

                    b.ToTable("SchoolSyncStates");
                });
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.StudentClassEnrollment", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SchoolId", "StudentId", "ClassGroupId")
                        .IsUnique()
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.SyncError", b =>
                {
                    b.Property<Guid>("SyncErrorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.SyncMetric", b =>
                {
                    b.Property<Guid>("SyncMetricId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("SyncMetricId");

                    b.HasIndex("SyncRunId")
                        .HasDatabaseName("IX_SyncMetrics_SyncRun");

                    b.ToTable("SyncMetrics");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.SyncPayloadArchive", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SchoolId", "ExpiresAtUtc")
                        .HasDatabaseName("IX_SyncPayloadArchives_ExpiresAt");

                    b.ToTable("SyncPayloadArchives");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.SyncRun", b =>
                {
                    b.Property<Guid>("SyncRunId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("SyncWatermark")
                        .HasColumnType("datetimeoffset");

                    b.Property<Guid>("TenantId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("WasFullSync")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("TenantId", "SchoolId", "ProviderId", "StartedAtUtc")
                        .HasDatabaseName("IX_SyncRuns_Provider_Started");

                    b.ToTable("SyncRuns");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.TelemetryEvent", b =>
                {
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.TierAssignment", b =>
                {
                    ...
                    b.HasIndex("TierDefinitionId");

                    b.ToTable("TierAssignments");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.TierAssignmentHistory", b =>
                {
                    ...
                    b.ToTable("TierAssignmentHistories");
                });

            modelBuilder.Entity("AnseoConnect.Data.Entities.TimelineEvent", b =>
                {
                    b.Property<Guid>("EventId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("TenantId", "SchoolId", "StudentId", "OccurredAtUtc")
                        .HasDatabaseName("IX_TimelineEvents_StudentId_OccurredAtUtc");

                    b.HasIndex("TenantId", "SchoolId", "StudentId", "Category", "OccurredAtUtc")
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.CaseIntervention", b =>
                {
                    ...
                    b.HasOne("AnseoConnect.Data.Entities.MtssIntervention", "Intervention")
                        .WithMany()
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.StudentClassEnrollment", b =>
                {
                    b.HasOne("AnseoConnect.Data.Entities.ClassGroup", "ClassGroup")
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.SyncError", b =>
                {
                    b.HasOne("AnseoConnect.Data.Entities.SyncRun", "SyncRun")
                        .WithMany("Errors")
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.TierAssignment", b =>
                {
                    ...
                    b.HasOne("AnseoConnect.Data.Entities.MtssTierDefinition", "TierDefinition")
                        .WithMany()
            ...
            modelBuilder.Entity("AnseoConnect.Data.Entities.TierAssignmentHistory", b =>
                {
                    b.HasOne("AnseoConnect.Data.Entities.TierAssignment", "Assignment")
                        .WithMany()
